...
public class GammaDistributionModel extends AbstractModel implements ParametricDistributionModel {
	...
	public double pdf(double x) { return GammaDistribution.pdf(x, getShape(), getScale()); }
	public double logPdf(double x) { return GammaDistribution.logPdf(x, getShape(), getScale()); }
	public double cdf(double x) { return GammaDistribution.cdf(x, getShape(), getScale()); }
	public double quantile(double y) { return GammaDistribution.quantile(y, getShape(), getScale()); }
	public double mean() { return GammaDistribution.mean(getShape(), getScale()); }
	public double variance() { return GammaDistribution.variance(getShape(), getScale()); }
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
		...
		public String getParserName() { return GAMMA_DISTRIBUTION_MODEL; }
		...
		public Class getReturnType() { return GammaDistributionModel.class; }
	};
	...
	private final double getShape() { return shapeParameter.getParameterValue(0);}
