...
Last updated: alexei@cs.auckland.ac.nz - 29th March 2010
...
Within the BEAST.v1.5.* package will be the following directories:
Directory       Contents
...
To run BEAUti simply double-click the "BEAUti v1.5.*.exe" file in the BEAST
...
To run BEAST simply double-click the "BEAST v1.5.*.exe" file in the BEAST
