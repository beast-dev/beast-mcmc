...
public class RandomWalkIntegerOperator extends SimpleMCMCOperator {
    ...
    public RandomWalkIntegerOperator(Parameter parameter, int windowSize, int weight) {
    ...
    public RandomWalkIntegerOperator(Parameter parameter, Parameter updateIndex, int windowSize, int weight) {
        this.parameter = parameter;
        this.windowSize = windowSize;
        setWeight(weight);
    ...
    public final double doOperation() {
        ...
        if (updateMap == null)
            ...
            index = ((Integer)updateMap.get(MathUtils.nextInt(updateMap.size()))).intValue();
