...
public class BeastParser extends XMLParser {
    ...
    private final void setup(String[] args) throws XMLParseException {
        ...
        addXMLObjectParser(dr.evomodel.coalescent.ARGCoalescentLikelihood.PARSER);
        addXMLObjectParser(dr.evomodel.coalescent.ARGUniformPrior.PARSER);
        ...
        addXMLObjectParser(dr.evomodel.operators.SlidingPatternsOperator.PARSER);
        ...
        addXMLObjectParser(dr.evomodel.tree.UniformPartitionLikelihood.PARSER);
        ...
        addXMLObjectParser(dr.evomodel.operators.ARGExchangeOperator.NARROW_EXCHANGE_PARSER);
        ...
        addXMLObjectParser(dr.evomodel.tree.ArgTreeLogger.PARSER);
        addXMLObjectParser(dr.evomodel.tree.ArgLogger.PARSER);
