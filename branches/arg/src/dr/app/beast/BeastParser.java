...
public class BeastParser extends XMLParser {
	...
	private final void setup(String[] args) throws XMLParseException {
		...
		addXMLObjectParser(dr.evomodel.arg.coalescent.VeryOldCoalescentLikelihood.PARSER);
		...
		addXMLObjectParser(dr.evomodel.arg.coalescent.SkylineLikelihood.PARSER);
		addXMLObjectParser(dr.evomodel.arg.coalescent.BayesianSkylineLikelihood.PARSER);
		...
		addXMLObjectParser(dr.inference.parallel.MPILikelihoodRunner.PARSER);
