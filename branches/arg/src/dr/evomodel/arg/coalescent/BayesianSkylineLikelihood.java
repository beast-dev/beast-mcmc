 ...
 */
public class BayesianSkylineLikelihood extends VeryOldCoalescentLikelihood {
	...
	public BayesianSkylineLikelihood(Tree tree, Parameter popSizeParameter, Parameter groupSizeParameter, int type) {
