...
public class ARGAddRemoveEventOperator extends SimpleMCMCOperator implements CoercableMCMCOperator {
	...
	public ARGAddRemoveEventOperator(ARGModel arg, int weight, double size, int mode,
