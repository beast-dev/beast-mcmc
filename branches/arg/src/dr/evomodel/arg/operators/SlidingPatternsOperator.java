 ...
 */
public class SlidingPatternsOperator extends SimpleMCMCOperator implements CoercableMCMCOperator {
	...
	public SlidingPatternsOperator(List<SitePatterns> list, Parameter breakPoints, int windowSize, int weight, int mode) {
...
//                    System.err.println("Found: "+((SitePatterns)obj).getId()) ;
			...
			VariableSizeParameter breakPoints = new VariableSizeParameter(dim);
