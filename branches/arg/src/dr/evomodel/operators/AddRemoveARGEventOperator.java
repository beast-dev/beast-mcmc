...
//import dr.evomodel.tree.VariableSizeTreeModel.VariableSizeNode;
...
//	if( !recParent1.bifurcation || recParent1.isRoot() ) { // One orientation is valid
	...
	public static dr.xml.XMLObjectParser PARSER = new dr.xml.AbstractXMLObjectParser() {
		...
		public Object parseXMLObject(XMLObject xo) throws XMLParseException {
			...
			return new AddRemoveARGEventOperator(treeModel, weight, size, gaussian, swapRates, swapTraits, mode,maxTips, parameter);
		}
		...
		public Class getReturnType() { return AddRemoveARGEventOperator.class; }
