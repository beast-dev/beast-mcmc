...
/**
 * An experimental parallelized MarkovChain. Works by evaluating multiple transition kernels in parallel and
 * then taking the first of these to accept the transition under the MH criterion.
 *
 * @author Andrew Rambaut
 * @version $Id: MarkovChain.java,v 1.10 2006/06/21 13:34:42 rambaut Exp $
 */
public final class ParallelMarkovChain {
    ...
    public ParallelMarkovChain(Prior prior, Likelihood likelihood,
