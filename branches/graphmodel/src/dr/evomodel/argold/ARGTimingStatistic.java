...
public class ARGTimingStatistic extends Statistic.Abstract{
	...
	public ARGTimingStatistic(String name, ARGModel arg){
		super(name);
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser(){
		...
		public Class getReturnType() {
			...
			return ARGTimingStatistic.class;
		}
...
//			int dim = xo.getIntegerAttribute(DIMENSION);
			...
			return new ARGTimingStatistic(name,arg);
		}
