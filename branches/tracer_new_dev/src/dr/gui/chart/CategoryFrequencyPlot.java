...
//import dr.stats.VariateGeneric;
//import dr.util.FrequencyDistribution;
//
//import java.awt.*;
//
//public class CategoryFrequencyPlot extends Plot.AbstractPlot {
...
//
//
//    public CategoryFrequencyPlot(Object[] data, int minimumBinCount) {
//        super();
...
//     * Set data
//     */
//    public void setData(Object[] data, int minimumBinCount) {
//
//        this.data = data;
//        FrequencyDistribution frequency = getFrequencyDistribution(data, minimumBinCount);
//
//        VariateGeneric.Category xData = new VariateGeneric.Category();
//        VariateGeneric.Category yData = new VariateGeneric.Category();
//
...
//    }
//
//    public VariateGeneric.Category getRawData() {
//        return raw;
//    }
//
//    public void setRawData(VariateGeneric.Category raw) {
//        this.raw = raw;
//    }
//
//    /**
...
//     */
//    protected FrequencyDistribution getFrequencyDistribution(VariateGeneric data, int minimumBinCount) {
...
//     * Paint data series
//     */
//    protected void paintData(Graphics2D g2, VariateGeneric xData, VariateGeneric yData) {
//
//        double x1, y1, x2, y2;
