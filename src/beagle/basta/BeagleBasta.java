...
public interface BeagleBasta extends Beagle {
    ...
    void setBastaPopulationSizesBuffer(double[] combinedSizesIntegrals, int requiredStorageSize, int bufferIndex);
    
    void setCurrentPopulationSizeBuffer(int bufferIndex);
