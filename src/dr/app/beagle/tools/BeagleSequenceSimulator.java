...
public class BeagleSequenceSimulator {
    ...
    protected EpochBranchSubstitutionModel substitutionModel;
    int categoryCount;
    int stateCount;

	static boolean hasAncestralSequence = false;
	protected Sequence ancestralSequence;
    
    protected double[][] transitionProbabilities;

	BeagleSequenceSimulator(Tree tree, //
...
//  public static final String SITE_MODEL = GammaSiteRateModel .SITE_MODEL;
  ...
  public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
    ...
    public static void main(String [] args) {
    	...
    	try {
    		...
    		BeagleSequenceSimulator treeSimulator = new BeagleSequenceSimulator(tree, //
    		siteModel, //
    		branchRateModel, //
    		freqModel, //
    		substitutionModel, //
