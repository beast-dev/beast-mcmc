 ...
 * @author Walter Xie
 * @version $Id: TipSpeciesPanel.java,2009/04/22 Walter Exp $
 */
public class TipSpeciesPanel extends BeautiPanel implements Exportable {

    /**
	 * 
	 */
	private static final long serialVersionUID = -5196086358458223200L;
    ...
    JCheckBox usingSpeciesDates = new JCheckBox("Use tip species");
    ...
    public TipSpeciesPanel(BeautiFrame parent) {
...
//        substitutionRateField.setEnabled(true);
        ...
        add(usingSpeciesDates, BorderLayout.NORTH);
        ...
        usingSpeciesDates.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent ev) {
                boolean enabled = usingSpeciesDates.isSelected();
