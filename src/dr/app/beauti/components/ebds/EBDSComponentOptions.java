...
/**
 * Options for the EpisodicBirthDeathSampling model and likelihood infrastructure
 *
 * @author Andrew Rambaut
 */

public class EBDSComponentOptions implements ComponentOptions {
	...
	public EBDSComponentOptions(final BeautiOptions options) {
