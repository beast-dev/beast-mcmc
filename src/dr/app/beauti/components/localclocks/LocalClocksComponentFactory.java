/*
 * LocalClockComponentFactory.java
 *
...
package dr.app.beauti.components.localclocks;

import dr.app.beauti.components.ComponentFactory;
import dr.app.beauti.components.tipdatesampling.TipDateSamplingComponentGenerator;
 ...
 * @version $Id$
 */
public class LocalClocksComponentFactory implements ComponentFactory {

    private LocalClocksComponentFactory() {
    ...
    public static ComponentFactory INSTANCE = new LocalClocksComponentFactory();
}