...
public class RealNumberField extends JTextField implements FocusListener, DocumentListener {
    ...
    protected static String POSITIVE_INFINITY = "+INF";
    protected static String NEGATIVE_INFINITY = "-INF";
    protected static String MAX_VALUE = "MAX_VALUE";
    protected static String MIN_VALUE = "MIN_VALUE";
