 ...
 * @version			$Id: CoalGenFrame.java,v 1.10 2004/10/01 22:40:02 alexei Exp $
 */
...
public class CoalGenFrame extends DocumentFrame {
	...
	public CoalGenFrame(Application application, String title) {
    	super();
	...
	protected boolean readFromFile(File file) throws FileNotFoundException, IOException {
		...
		try {
			...
			Thread readThread = new Thread () {
				public void run() {
					try {
						final Traces traces = Traces.loadTraces(reader, fileName);
	...
	public Action getImportAction() { return importTaxaAction; }
	...
	public Action getExportAction() { return generateSimulationsAction; }
