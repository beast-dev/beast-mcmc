    ...
    public void writeMCMC(XMLWriter writer) {
        ...
        writer.writeOpenTag(LoggerParser.LOG,
                new Attribute[]{
                        ...
                        new Attribute.Default(LoggerParser.LOG_EVERY, echoEvery + "")
                });
        ...
        writer.writeOpenTag(LoggerParser.LOG,
                new Attribute[]{
                        ...
                        new Attribute.Default(LoggerParser.LOG_EVERY, logEvery + ""),
                        new Attribute.Default(LoggerParser.FILE_NAME, logFileName)
                });
        ...
        writer.writeOpenTag(TreeLoggerParser.LOG_TREE,
                new Attribute[]{
                        ...
                        new Attribute.Default(TreeLoggerParser.LOG_EVERY, logEvery + ""),
                        new Attribute.Default(TreeLoggerParser.NEXUS_FORMAT, "true"),
                        new Attribute.Default(TreeLoggerParser.FILE_NAME, treeFileName)
                });
        writer.writeTag(TreeModel.TREE_MODEL, new Attribute.Default("idref", "treeModel1"), true);
