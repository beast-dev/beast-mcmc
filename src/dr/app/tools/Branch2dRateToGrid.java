    ...
    public static void main(String[] args) throws IOException {
        ...
        Arguments arguments = new Arguments(
                new Arguments.Option[]{
                        ...
                        new Arguments.IntegerOption(SKIP, "s", "skip every i'th tree [default = 0]"),
                        new Arguments.StringOption(TRAIT, "t",  "trait_name", "specifies an attribute to use to summarize the 2D trait info [default = location]"),
                        new Arguments.StringOption(RATE_ATTRIBUTE, null, "rate_attribute", "specifies the trait rate attribute string [default=rate]"),
                        new Arguments.Option(HELP, "h", "option to print this message"),
                        new Arguments.StringOption(TRAIT_NOISE, null, falseTrue, false,
                                "add true noise to 2D traits [default = true])"),
                        new Arguments.StringOption(RATE_NOISE, null, falseTrue, false,
                        ...
                        new Arguments.RealOption(LATMAX, null, "specifies the maximum latitude for the grid [default=90]"),
                        new Arguments.RealOption(LATMIN, null, "specifies the minimum latitude for the grid [default=-90]"),
                        new Arguments.RealOption(LONGMAX, null, "specifies the maximum longitude for the grid [default=180]"),
                        new Arguments.RealOption(LONGMIN, null, "specifies the minimum longitude for the grid [default=-180]"),
                        new Arguments.IntegerOption(GRIDXCELLS, null, "the number of cells along the x-axis (longitude) of the grid [default = 360]"),
                        new Arguments.IntegerOption(GRIDYCELLS, null, "the number of cells along the y-axis (latitude) of the grid [default = 180]"),
                        new Arguments.RealOption(MAXPATHLENGTH, null, "specifies the maximum (time) length a branch can go in one direction before adding Brownian noise to it [default=MAX_VALUE (no noise)]"),
                        ...
                        new Arguments.StringOption(STDEVS, null, falseTrue, true,
                                "get standard deviations for the rates [default = true])"),
                        new Arguments.RealOption(CUTOFF, null, "specifies the posterior cut-off for summarize grid values [default=-0]"),
                        new Arguments.StringOption(DISCRETE_TRAIT_NAME, null, "discrete_traitName", "specifies the name for a discrete trait that is annotated to the tree nodes and by which states the grid needs to be summarized [default=none]"),
                        new Arguments.StringOption(DISCRETE_TRAIT_STATES, null, "discrete_traitStates", "specifies the state of a discrete trait by which the grid needs to be summarized [default=none]"),
                        new Arguments.StringOption(HISTORY_ANNOTATION, null, "history_annotation", "specifies the name for the history annotation for the discrete trait [default=history]"),
