    ...
    public static void main(String[] args) throws IOException {
        ...
        Arguments arguments = new Arguments(
                new Arguments.Option[]{
                        new Arguments.StringOption("type", null, new String[]{"mcc", "hipstr"}, false, "an option of 'mcc' or 'hipstr'"),
                        new Arguments.StringOption("heights", null, new String[]{"keep", "median", "mean", "ca"}, false,
                                "an option of 'keep', 'median', 'mean' or 'ca' (default)"),
                        new Arguments.LongOption("burnin", null, "the number of states to be considered as 'burn-in'"),
                        new Arguments.IntegerOption("burninTrees", null, "the number of trees to be considered as 'burn-in'"),
