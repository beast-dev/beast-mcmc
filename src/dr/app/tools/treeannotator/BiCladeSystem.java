 ...
 * @version $
 */
class BiCladeSystem implements CladeSystem {
    //
    // Public stuff
    //
     ...
     */
    private Clade getClade(int tipIndex) {
     ...
     */
    private Clade getClade(Clade child1, Clade child2) {
...
//            clade = new BiClade(clade1, clade2, tree.getExternalNodeCount());
//        }
//
...
//    }
    ...
    Map<Object, Clade> tipClades = new HashMap<>();
