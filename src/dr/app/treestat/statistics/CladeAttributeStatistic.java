 ...
 */
public class CladeAttributeStatistic extends AbstractTreeSummaryStatistic {

    private CladeAttributeStatistic() {
        this.attributeName = "";
    }
    ...
    public String getSummaryStatisticDescription() {
        if (taxonList != null) {
            return "Extracts a named attribute of a clade defined by a taxon set";
        }
        return "Extracts a named attribute of the root of the tree.";
    }
    ...
    public static final Factory FACTORY = new Factory() {
        ...
        public TreeSummaryStatistic createStatistic() {
            return new CladeAttributeStatistic();
        }

        public String getSummaryStatisticName() {
            return "Clade Attribute";
        }
