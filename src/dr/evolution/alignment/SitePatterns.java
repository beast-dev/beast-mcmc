...
public class SitePatterns implements SiteList, dr.util.XHTMLable {
   ...
   public SitePatterns(SiteList siteList, int from, int to, int every) {
	...
	public SiteList getSiteList() { return siteList;}

	public int getFrom() { return from; }
	public int getTo() { return to; }
	public int getEvery() { return every; }
	
	public void setFrom(int from) { setPatterns(getSiteList(), from, getTo(), getEvery()); }
	public void setTo(int to) { setPatterns(getSiteList(), getFrom(), to, getEvery()); }
	public void setEvery(int every) { setPatterns(getSiteList(), getFrom(), getTo(), every); }
