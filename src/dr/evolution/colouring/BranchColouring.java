...
public class BranchColouring {

	public final static boolean checkSanity = true;
	
	public BranchColouring() {
		
		this.parentColour = -1;
		
	}
	
	public BranchColouring( int parentColour, int childColour ) {
	...
	public BranchColouring( BranchColouring history ) {
	...
	public BranchColouring getCopy() {
		
		return new BranchColouring( this );
	 ...
	 */
	void addHistory( BranchColouring history ) {
