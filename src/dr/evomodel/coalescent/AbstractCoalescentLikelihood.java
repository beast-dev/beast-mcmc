...
public abstract class AbstractCoalescentLikelihood extends AbstractModel implements Likelihood, Units {
    ...
    public AbstractCoalescentLikelihood(Tree tree, DemographicModel demoModel) {
        this(COALESCENT_LIKELIHOOD, tree, demoModel, true);
    }

    public AbstractCoalescentLikelihood(MultiLociTreeSet treesSet, DemographicModel demoModel) {
    ...
    public AbstractCoalescentLikelihood(String name, Tree tree, DemographicModel demoModel, boolean setupIntervals) {
        super(name);
