...
public class ExponentialLogisticModel extends DemographicModel
{
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
		...
		public String getParserName() { return EXPONENTIAL_LOGISTIC_MODEL; }
		...
		public Object parseXMLObject(XMLObject xo) throws XMLParseException {
			...
			cxo = (XMLObject)xo.getChild(LOGISTIC_GROWTH_RATE);
			Parameter logGrowthParam = (Parameter)cxo.getChild(Parameter.class);

			cxo = (XMLObject)xo.getChild(LOGISTIC_SHAPE);
			Parameter shapeParam = (Parameter)cxo.getChild(Parameter.class);

			cxo = (XMLObject)xo.getChild(EXPONENTIAL_GROWTH_RATE);
