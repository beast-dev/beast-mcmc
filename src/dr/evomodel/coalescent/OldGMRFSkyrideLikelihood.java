...
public class OldGMRFSkyrideLikelihood extends OldAbstractCoalescentLikelihood implements CoalescentIntervalProvider, Citable {
    ...
    public OldGMRFSkyrideLikelihood(String name) {
        super(name);
    }

    public OldGMRFSkyrideLikelihood(Tree tree, Parameter popParameter, Parameter groupParameter, Parameter precParameter,
    ...
    public OldGMRFSkyrideLikelihood(List<Tree> treeList, Parameter popParameter, Parameter groupParameter, Parameter precParameter,
                                    Parameter lambda, Parameter beta, MatrixParameter dMatrix,
                                    boolean timeAwareSmoothing, boolean rescaleByRootHeight) {
