...
public class StructuredCoalescentLikelihoodParser extends AbstractXMLObjectParser {
    ...
    private Object parseBasta(XMLObject xo) throws XMLParseException {
        ...
        Parameter popSizes = xo.hasChildNamed(POPULATION_SIZES) ? (Parameter) xo.getElementFirstChild(POPULATION_SIZES) : null;
        ...
        if (popSizes != null && logPopSizes != null) {
            throw new XMLParseException("Cannot specify both " + POPULATION_SIZES + " and " + LOG_POP_SIZES);
        }
                ...
                if (USE_OLD_CODE) {
                    ...
                    if (USE_DELEGATE) {
                        ...
                        if (ancestralR != null) {
                            ...
                            XMLObject anchorElement = xo.getChild(inputIsLog ? LOG_POP_SIZES : POPULATION_SIZES);
                            if (anchorSize.getDimension() != 1) {
                                throw new XMLParseException("The shared anchor population size (" +
                                        (inputIsLog ? LOG_POP_SIZES : POPULATION_SIZES) +
                            ...
                            if (anchorProportion != null) {
                                ...
                                throw new XMLParseException("The shared-ancestral exponential model requires either an " +
                                        ...
                                        (inputIsLog ? LOG_POP_SIZES : POPULATION_SIZES) + " element");
                            }
                            ...
                            XMLObject popSizesElement = xo.getChild(POPULATION_SIZES);
