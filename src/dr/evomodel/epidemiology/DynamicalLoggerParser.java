 ...
 */
public class DynamicalLoggerParser extends AbstractXMLObjectParser {

    public static final String LOG = "logDynamics";
   ...
   //     SIRModel model = (SIRModel) xo.getStringAttribute(SIRModel.class);
        SIRModel model = null;
        ...
        final DynamicalLogger logger = new DynamicalLogger(model, formatter, logEvery);
