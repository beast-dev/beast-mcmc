 ...
 * @version $Id: $
 */
public class OldCaseToCaseTransmissionLikelihood extends AbstractModelLikelihood implements Loggable, Citable {
...
/*    private HashMap<AbstractCase, Double> treeInfectionDates;
    ...
    public static final String OLD_CASE_TO_CASE_TRANSMISSION_LIKELIHOOD = "oldCaseToCaseTransmissionLikelihood";

    // Basic constructor.

    public OldCaseToCaseTransmissionLikelihood(TreeModel virusTree, AbstractCaseSet caseData,
                                               String startingNetworkFileName)
            throws TaxonList.MissingTaxonException {
        this(OLD_CASE_TO_CASE_TRANSMISSION_LIKELIHOOD, virusTree, caseData, startingNetworkFileName);
    }


    // Constructor for an instance with a non-default name

    public OldCaseToCaseTransmissionLikelihood(String name, TreeModel virusTree, AbstractCaseSet caseData, String
    ...
    */
    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        public String getParserName() {
            return OLD_CASE_TO_CASE_TRANSMISSION_LIKELIHOOD;
        }
        ...
        public Object parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            OldCaseToCaseTransmissionLikelihood likelihood;

            try {
                likelihood = new OldCaseToCaseTransmissionLikelihood(virusTree, caseSet, startingNetworkFileName);
        ...
        public Class getReturnType() {
            return OldCaseToCaseTransmissionLikelihood.class;
        }
