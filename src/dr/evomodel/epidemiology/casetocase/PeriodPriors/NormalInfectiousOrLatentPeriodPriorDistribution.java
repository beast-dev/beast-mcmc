...
/**
 ...
 @author Matthew Hall
 */
public class NormalInfectiousOrLatentPeriodPriorDistribution extends InfectiousOrLatentPeriodPriorDistribution {

    public static final String NORMAL = "normalInfectiousOrLatentPeriodPriorDistribution";
    ...
    public NormalInfectiousOrLatentPeriodPriorDistribution(String name, boolean log,
                                                           NormalGammaDistribution hyperprior){
        super(name, log);
        this.hyperprior = hyperprior;
        posteriorBeta = new Parameter.Default(0);
        posteriorMean = new Parameter.Default(0);
        addVariable(posteriorBeta);
        addVariable(posteriorMean);
    }

    public NormalInfectiousOrLatentPeriodPriorDistribution(String name, boolean log, double mu_0, double lambda_0,
    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        public Object parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            double mu = xo.getDoubleAttribute(ALPHA);
            double lambda = xo.getDoubleAttribute(ALPHA);
            double alpha = xo.getDoubleAttribute(ALPHA);
            double beta = xo.getDoubleAttribute(ALPHA);

            boolean log;
            log = xo.hasAttribute(LOG) ? xo.getBooleanAttribute(LOG) : false;

            return new NormalInfectiousOrLatentPeriodPriorDistribution(id, log, mu, lambda, alpha, beta);
