 ...
 * @version $Id$
 */
public class AdaptiveRerootOperator extends AbstractTreeOperator implements CoercableMCMCOperator {
     ...
     */
    public AdaptiveRerootOperator(TreeModel tree, double weight, double size, double accP, CoercionMode mode) {
        this.tree = tree;
        setWeight(weight);
        this.size = size;
        this.accP = accP;
    ...
    public double doOperation() {
        ...
        final Map<NodeRef, Double> destinations = getDestinations(root, delta);
...
//        }
        ...
        final Map<NodeRef, Double> reverseDestinations = getDestinations(root, delta);
    ...
    private Map<NodeRef, Double> getDestinations(NodeRef node, double delta) {
        ...
        getIntersectingEdges(tree, tree.getChild(node, 0), heightBelow, edges);
        getIntersectingEdges(tree, tree.getChild(node, 1), heightBelow, edges);
