...
public class SpeciesTreeModel extends AbstractModel implements MutableTree, NodeAttributeProvider {
    ...
    private class Args {
        ...
        final double[] indicators = coalPointsIndicator.inspectParametersValues();
        final double[] pops = coalPointsPops.inspectParametersValues();
...
//        double[] ys = new double[plen + (isRoot ? 2 : 2)];
    ...
    private void setNodeProperties() {
        ...
        setDemographics(getRoot(), 0, -1, sppSplitPopulations.inspectParametersValues(), perBranchPoints);
    }
