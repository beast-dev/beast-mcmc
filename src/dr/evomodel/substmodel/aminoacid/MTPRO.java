...
/**
 * MTPRO model of amino acid evolution
 * Le, V. S., Dang, C. C., and Le, Q. S. 2017. BMC Evol. Biol. 17:136.
 *
 * @author Guy Baele
 */
public class MTPRO extends EmpiricalRateMatrix.AbstractAminoAcid {

	public static final MTPRO INSTANCE = new MTPRO();
	...
	public String getDescription() {
		return "mtPro amino acid substitution model";
	}
