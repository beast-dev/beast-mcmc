...
//        this.samplingVariance = new Matrix(samplingPrecision.getParameterAsMatrix()).inverse();
    ...
    public RepeatedMeasuresTraitDataModel(String name,
                                          ...
                                          final int dimTrait,
                                          MatrixParameterInterface samplingPrecision) {
        this(name, childModel, parameter, missindIndicators, useMissingIndices, dimTrait, 1, samplingPrecision,
    ...
    public double[] getTipPartial(int taxonIndex, boolean fullyObserved) {
        ...
        partial = scalePartialwithSamplingPrecision(partial, taxonIndex, dimTrait);
    ...
    protected double[] scalePartialwithSamplingPrecision(double[] partial, int taxonIndex, int dimTrait) {
