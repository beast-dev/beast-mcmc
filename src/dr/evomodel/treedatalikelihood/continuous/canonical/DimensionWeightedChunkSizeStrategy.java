 ...
 */
final class DimensionWeightedChunkSizeStrategy implements ChunkSizeStrategy {
    ...
    DimensionWeightedChunkSizeStrategy(final int dimension, final int workerCount) {
