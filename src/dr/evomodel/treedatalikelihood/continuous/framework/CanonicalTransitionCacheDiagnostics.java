/*
 * CanonicalTransitionCacheDiagnostics.java
 *
...
/**
 * Optional capability for transition-cache phase labelling and diagnostics.
 */
public interface CanonicalTransitionCacheDiagnostics {

    String pushDiagnosticPhase(String phase);
