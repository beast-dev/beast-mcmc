...
import dr.evomodel.treedatalikelihood.continuous.ContinuousRewardsAwareMixtureBranchRatesLocationScaleGradient;
...
public final class ContinuousRewardsAwareMixtureBranchRatesLocationScaleGradientParser
        extends AbstractXMLObjectParser {

    private static final String NAME = "continuousRewardsAwareMixtureBranchRatesLocationScaleGradient";
    ...
    public Object parseXMLObject(XMLObject xo) throws XMLParseException {
        ...
        final ContinuousRewardsAwareMixtureBranchRatesLocationScaleGradient gradient =
                new ContinuousRewardsAwareMixtureBranchRatesLocationScaleGradient(
                        traitName,
                        treeDataLikelihood,
                        branchRateModel,
    ...
    public String getParserDescription() {
        return "Provides the continuous-trait gradient with respect to the location and scale "
                + "of a linear RewardsAwareMixtureBranchRates transform.";
    }

    @Override
    public Class getReturnType() {
        return ContinuousRewardsAwareMixtureBranchRatesLocationScaleGradient.class;
    }
}
