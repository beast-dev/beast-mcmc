...
/**
 * Created by mkarcher on 11/2/16.
 */
public class BNPRLikelihoodParser extends AbstractXMLObjectParser {

    public static final String BNPR_LIKELIHOOD = "bnprLikelihood";
