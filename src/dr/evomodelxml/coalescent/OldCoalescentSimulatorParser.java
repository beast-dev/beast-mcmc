...
/**
 * The original Coalescent Simulator parser. Responds to the parser name 'coalescentTree'.
 * This has been replaced, since v1.7.4 by a more flexible class, CoalescentSimulator, with
 * parser name 'coalescentSimulator'. Left for backwards XML compatibility.
 *
 * @deprecated
 */
