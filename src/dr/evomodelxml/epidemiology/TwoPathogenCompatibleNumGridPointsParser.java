...
import dr.evomodel.epidemiology.TwoPathogenCompatibleNumGridPoints;
import dr.inference.model.Parameter;
import dr.xml.*;

public class TwoPathogenCompatibleNumGridPointsParser extends AbstractXMLObjectParser {

    public static final String TWO_PATHOGEN_COMPATIBLE_NUM_GRID_POINTS = "twoPathogenCompatibleNumGridPoints";
    ...
    public Object parseXMLObject(XMLObject xo) throws XMLParseException {
        ...
        return new TwoPathogenCompatibleNumGridPoints(cutOff, numGridPoints,
    ...
    public String getParserName() {
        return TWO_PATHOGEN_COMPATIBLE_NUM_GRID_POINTS;
    }
}
