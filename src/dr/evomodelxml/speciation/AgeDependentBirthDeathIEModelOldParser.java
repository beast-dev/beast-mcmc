...
import dr.evomodel.speciation.agedependent.AgeDependentBirthDeathIEModelOld;
import dr.inference.model.Parameter;
import dr.xml.*;

public class AgeDependentBirthDeathIEModelOldParser extends AbstractXMLObjectParser {
    ...
    public Object parseXMLObject(XMLObject xo) throws XMLParseException {
        ...
        return new AgeDependentBirthDeathIEModelOld(
                xo.getId(),
                tree,
                epochTimes,
                birthScale,
    ...
    public Class getReturnType() {
        return AgeDependentBirthDeathIEModelOld.class;
    }
