...
public class RepeatedMeasuresTraitDataModelParser extends AbstractXMLObjectParser implements BeautiModelIDProvider {
    ...
    public Object parseXMLObject(XMLObject xo) throws XMLParseException {
        ...
        if (!scaleByTipHeight) {
            if (subModel instanceof IntegratedProcessTraitDataModel) { //TODO: need to add to interface
                return new RepeatedMeasuresIntegratedProcessTraitDataModel( //TODO: need to integrate this with new framework
                        modelName,
                        subModel,
