...
public class GeoMultiSpatialCollectionModel extends AbstractModelLikelihood {

    public GeoMultiSpatialCollectionModel(String name, Parameter points, List<GeoMultiSpatialDistribution> geoMultiSpatialDistributions) {

        super(name);
        this.points = points;
        this.geoMultiSpatialDistributions = geoMultiSpatialDistributions;
    ...
    protected void handleVariableChangedEvent(Variable variable, int index, Parameter.ChangeType type) {
        ...
        validPointLogLikelihood[index / GeoMultiSpatialDistribution.dimPoint] = false;
        likelihoodKnown = false;
    }
    ...
    public double getLogLikelihood() {
        ...
        for (int i = 0; i < dim; i++) {
            if (!validPointLogLikelihood[i]) {
                ...
                for (GeoMultiSpatialDistribution distribution : geoMultiSpatialDistributions) {
    ...
    private List<GeoMultiSpatialDistribution> geoMultiSpatialDistributions;
    private int dim;
