...
import dr.inferencexml.distribution.GeneralizedAdditiveGaussianProcessModelParser;
 ...
 * @author Marc Suchard
 */
public class GeneralizedAdditiveModel  extends AbstractModelLikelihood implements MultivariateFunction {
    ...
    public GeneralizedAdditiveModel(Parameter dependentParam) {
        super(GeneralizedAdditiveGaussianProcessModelParser.GAM_GP_LIKELIHOOD);
