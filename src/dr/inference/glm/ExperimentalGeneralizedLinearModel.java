/*
 * ExperimentalGeneralizedLinearModel.java
 *
...
public final class ExperimentalGeneralizedLinearModel extends AbstractModelLikelihood {
    ...
    private final List<Parameter> independentParameter = new ArrayList<>();
    private final List<Parameter> independentParameterDelta = new ArrayList<>();
    private final List<DesignMatrix> designMatrix = new ArrayList<>();

    private int numIndependentVariables = 0;
    private int numRandomEffects = 0;
    private int N;

    private List<Parameter> randomEffects = null;
    ...
    public static boolean checkFullRank(List<DesignMatrix> designMatrix, int n) {
        int totalColDim = 0;
    ...
    public boolean getAllIndependentVariablesIdentifiable() {
        return checkFullRank(designMatrix, N);
    }

    public double[] getXBeta() {
        return getXBeta(N, numIndependentVariables, independentParameter, independentParameterDelta,
                designMatrix, numRandomEffects, randomEffects);
    }

    public static double[] getXBeta(int n, int numIndependentVariables, List<Parameter> independentParameter,
                                    List<Parameter> independentParameterDelta, List<DesignMatrix> designMatrix,
                                    int numRandomEffects, List<Parameter> randomEffects) {
