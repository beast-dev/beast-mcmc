 ...
 *          $LastChangedRevision$
 */
public class NativeHPHSingleton {

    private static final String LIBRARY_NAME = "hph_jni";
    private static final String LIBRARY_PATH_LABEL = "hph.library.path";
    ...
    static final String THREADS = "hph.threads";
    static final String HPH_RESOURCE = "hph.resource";
...
//    }
    ...
    public static NativeHPHSingleton loadLibrary() throws UnsatisfiedLinkError {

        if (INSTANCE == null) {
            System.err.println("Trying to load HPH library...");
            String path = "";
            ...
            INSTANCE = new NativeHPHSingleton();
            System.err.println("HPH library loaded.");
        }

        return INSTANCE;
    }

    private static NativeHPHSingleton INSTANCE = null;

    public int initialize(int dimensionCount, int locationCount, HawkesCore.CoreInformation information) {
