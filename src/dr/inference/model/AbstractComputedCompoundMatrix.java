...
//    }
    ...
    protected void restoreValues() {
        super.restoreValues();
        // Cached entries live in subclass-owned buffers. We cannot safely assume those
        // buffers still represent the restored child-parameter state after a rejected move.
        // Force a lazy rebuild from restored children on next access.
        matrixKnown = false;
    }
