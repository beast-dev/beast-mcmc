 ...
 * @author Marc Suchard
 */
public class OldMatrixParameter extends CompoundParameter {

    public final static String MATRIX_PARAMETER = "matrixParameter";

    public OldMatrixParameter(String name) {
        super(name);
    }

    public OldMatrixParameter(String name, Parameter[] parameters) {
        super(parameters);
    }
    ...
    public static OldMatrixParameter parseFromSymmetricString(String string) {
        ...
        return new OldMatrixParameter(null, parameter);
    }

    public static OldMatrixParameter parseFromSymmetricDoubleArray(Object[] data) {
...
//    }
    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        public Object parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            OldMatrixParameter matrixParameter = new OldMatrixParameter(MATRIX_PARAMETER);
        ...
        public Class getReturnType() {
            return OldMatrixParameter.class;
        }
    };
