...
public class CenteredScaleOperator extends SimpleMCMCOperator implements CoercableMCMCOperator {
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
		...
		public String getParserName() { return CENTERED_SCALE; }
		...
		public Class getReturnType() { return CenteredScaleOperator.class; }
	...
	public String toString() { return getOperatorName() + "(scaleFactor=" + scaleFactor + ")"; }
