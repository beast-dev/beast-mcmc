...
public class GTR extends AbstractNucleotideModel
{
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
		...
		public String getParserName() { return GTR_MODEL; }
		...
		public Object parseXMLObject(XMLObject xo) throws XMLParseException {
			...
			if (countNull != 1) throw new XMLParseException("Only five parameters may be specified in GTR, leave exactly one out, the others will be specifed relative to the one left out.");
