...
public class LNVarianceOperator extends ScaleOperator {
    ...
    public LNVarianceOperator(LogNormalDistributionModel lnd, double scaleFactor, double weight, int mode) {

        //  super(lnd.getSParameter(), false, scaleFactor, weight, mode, null, 0.0);
        super(lnd.getSParameter(), false, 0, scaleFactor, mode, null, 0);
        this.lnd = lnd;
        setWeight(weight);
    }
