...
of demographic parameters from genetic data \cite{Beaumont1999,DNRS2002,WWB2003,RY2003,PDNRR2003,Kuhner2006}.
...
to 1994. Because this virus evolves at a rapid rate, the sampling times can be
used by BEAST as calibrations to estimate the overall substitution rate and the
divergence times in years. We analyze the data under two different substitution
models and two different models of rates variation among branches: the strict
clock and the uncorrelated lognormal-distributed relaxed molecular clock. We 
use the constant population size coalescent as the tree prior. 
\\\\
\begin{tabular}{|c|c|c|l|}
	\hline
Clock Model & Substitution Model & Marginal Likelihood & Root height  \\
	\hline
...
protein-coding sequence with introns removed) the Goldman and Yang model \cite{GY1994} can be used to model
codon evolution. 
