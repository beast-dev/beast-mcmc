...
go for a chain length of 1,000,000. Go back to Section~\ref{section:Setting the MCMC options}
...
\begin{center}
\leavevmode
\scalebox{0.3}{\includegraphics{Figure9_Tracer5.png}}
\end{center}
...
\begin{center}
\leavevmode
\scalebox{0.4}{\includegraphics{Figure10_TreeAnnotator.png}}
\end{center}
...
\begin{center}
\leavevmode
\scalebox{0.3}{\includegraphics{Figure11_FigTree.png}}
\end{center}
