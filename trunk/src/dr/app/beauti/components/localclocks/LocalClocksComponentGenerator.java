/*
 * LocalClocksComponentGenerator.java
 *
 ...
 * @version $Id$
 */
public class LocalClocksComponentGenerator extends BaseComponentGenerator {

    public LocalClocksComponentGenerator(final BeautiOptions options) {
        super(options);
    }
