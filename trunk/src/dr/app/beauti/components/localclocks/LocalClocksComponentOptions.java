/*
 * LocalClocksComponentOptions.java
 *
 ...
 * @version $Id$
 */
public class LocalClocksComponentOptions implements ComponentOptions {

    private final BeautiOptions options;

    public LocalClocksComponentOptions(final BeautiOptions options) {
