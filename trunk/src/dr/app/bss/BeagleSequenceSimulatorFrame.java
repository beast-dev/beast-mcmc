...
//		System.out.println("TODO: generateXML");
	...
	private void writeBranchRatesModel(PartitionData data, XMLWriter writer) {
		...
		int clockModel = data.clockModel;
		  ...
		  case 0: // StrictClock
              ...
              attributes.add(new Attribute.Default<String>(XMLParser.ID, "clock.rate"));
              attributes.add(new Attribute.Default<String>(ParameterParser.VALUE, String.valueOf(data.clockParameterValues[0]) ) );
	...
	private void writeStartingTree(TreeModel tree, XMLWriter writer) {
        ...
        writer.writeOpenTag(
                NewickParser.NEWICK,
                new Attribute[]{
                        new Attribute.Default<String>(XMLParser.ID, BeagleSequenceSimulatorApp.STARTING_TREE),
