...
* parameters for lognormal clock model should be on a log scale or there should be a boolean switch for real/log scales
* parser fo routput type should be case insensitive
