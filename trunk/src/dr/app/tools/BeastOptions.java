...
public class BeastOptions {
	...
	public void writeNucSiteModel(int num, XMLWriter writer) {
		...
		switch (nucSubstitutionModel) {
			...
			case JC: writer.writeTag(dr.evomodel.substmodel.HKY.HKY_MODEL, new Attribute.Default("idref", "jc1"), true); break;
			case HKY: writer.writeTag(dr.evomodel.substmodel.HKY.HKY_MODEL, new Attribute.Default("idref", "hky" + n), true); break;
			case GTR: writer.writeTag(dr.evomodel.substmodel.GTR.GTR_MODEL, new Attribute.Default("idref", "gtr" + n), true); break;
