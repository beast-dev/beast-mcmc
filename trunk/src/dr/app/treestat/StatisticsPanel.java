...
//		availableStatistics.add(dr.app.treestat.statistics.IntervalKStatistic(1).FACTORY);
//		availableStatistics.add(dr.app.treestat.statistics.IntervalKStatistic(2).FACTORY);
