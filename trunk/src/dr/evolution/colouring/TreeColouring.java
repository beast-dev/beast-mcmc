 ...
 */
public class TreeColouring {

    public TreeColouring(int colourCount, Tree tree) {
        this.colourCount = colourCount;
        this.tree = tree;
        branchColourings = new BranchColouring[tree.getNodeCount()];
        colourChangeCount = 0;
    }

    /* Creates a mutable copy of the colouring (without probability assigned) */
    public TreeColouring( TreeColouring treeColouring ) {
    	...
    	branchColourings = (BranchColouring[])treeColouring.branchColourings.clone();      // Shallow copy
    ...
    public void setBranchColouring(NodeRef node, BranchColouring branchColouring) {
...
*/
    ...
    private final BranchColouring[] branchColourings;
