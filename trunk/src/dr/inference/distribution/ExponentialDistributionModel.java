...
public class ExponentialDistributionModel extends AbstractModel implements ParametricDistributionModel {
	...
	public double mean() { return ExponentialDistribution.mean(1.0 / getMean())+offset; }
	public double variance() { return ExponentialDistribution.variance(1.0 / getMean()); }
	...
	private UnivariateFunction pdfFunction = new UnivariateFunction() {
		...
		public final double getLowerBound() { return offset; }
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
		...
		public String getParserName() { return EXPONENTIAL_DISTRIBUTION_MODEL; }
		...
		public Class getReturnType() { return ExponentialDistributionModel.class; }
