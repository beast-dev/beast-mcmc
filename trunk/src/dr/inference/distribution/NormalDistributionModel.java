...
public class NormalDistributionModel extends AbstractModel implements ParametricDistributionModel {
	...
	public double pdf(double x) { return NormalDistribution.pdf(x, mean(), getStdev()); }
	public double logPdf(double x) { return NormalDistribution.logPdf(x, mean(), getStdev()); }
	public double cdf(double x) { return NormalDistribution.cdf(x, mean(), getStdev()); }
	public double quantile(double y) { return NormalDistribution.quantile(y, mean(), getStdev()); }
	public double mean() { return meanParameter.getParameterValue(0); }
	public double variance() { return NormalDistribution.variance(mean(), getStdev()); }
	...
	public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
		...
		public Class getReturnType() { return NormalDistributionModel.class; }
	};
