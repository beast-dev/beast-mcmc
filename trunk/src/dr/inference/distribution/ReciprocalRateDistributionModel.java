...
/*
 * ReciprocalRateNormalDistributionModel.java
 *
...
/**
 * A class that acts as a model for rates to be the reciprocal of the previous rate.
 *
 * @author Wai Lok Sibon Li
 * @author Alexei Drummond
 * @version $Id: ReciprocalRateDistributionModel.java,v 1.8 2009/03/30 20:25:59 rambaut Exp $
 */

public class ReciprocalRateDistributionModel extends AbstractModel implements ParametricDistributionModel {


    public static final String NORMAL_DISTRIBUTION_MODEL = "ReciprocalRateNormalDistributionModel";
     ...
     * Constructor.
     */
    public ReciprocalRateDistributionModel(Parameter meanParameter, Parameter stdevParameter, double offset, boolean meanInRealSpace) {
    ...
    public ReciprocalRateDistributionModel(Parameter meanParameter, Parameter scaleParameter,
    ...
    /**
     * @return the mean (always in reciprocal? space)
     */
    public final double getM() {
        if (isMeanInRealSpace) {
            double stDev = getStDev();
            double M = Math.log(meanParameter.getParameterValue(0)) - (0.5 * stDev * stDev);
            //double M = (1.0/(meanParameter.getParameterValue(0))) - (0.5 * stDev * stDev);
            return M;
        } else {
    ...
    public double pdf(double x) {
        ...
        return NormalDistribution.pdf(1.0/(x - offset), getM(), getStDev()) / (x - offset);
    }
    ...
    public double cdf(double x) {
        ...
        return NormalDistribution.cdf(1.0/(x - offset), getM(), getStDev());
    }
    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        public Object parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            if (cxo != null) {
                ...
                return new ReciprocalRateDistributionModel(meanParam, precParam, offset, false);
            } else {
                ...
                return new ReciprocalRateDistributionModel(meanParam, stdevParam, offset, meanInRealSpace);
            }
        }
        ...
        public Class getReturnType() {
            return ReciprocalRateDistributionModel.class;
        }
    };
