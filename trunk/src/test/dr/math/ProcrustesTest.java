...
public class ProcrustesTest extends MathTestCase {
    ...
    public void testProcrustes() {
        runTest(X, Xstar, gldStd[0], false, false, "No translation, no dilation");
        runTest(X, Xstar, gldStd[1], true, false,  "Yes translation, no dilation");
        runTest(X, Xstar, gldStd[2], false, true,  "No translation, yes dilation");

    }

    private void runTest(double[][] X, double[][] Xstar, double[][] goldStandard,
                         boolean allowTranslation, boolean allowDilation, String header) {
